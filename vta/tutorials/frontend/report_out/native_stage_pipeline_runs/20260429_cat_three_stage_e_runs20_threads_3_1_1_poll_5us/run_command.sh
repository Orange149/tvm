#!/usr/bin/env bash
set -euo pipefail
OUT_DIR="/tmp/vta_stage_pipeline_results_3_1_1_poll_5us"
mkdir -p "$OUT_DIR"
AXU5EVB_DRIVER_POST_START_SLEEP_NS=5000 \
AXU5EVB_DRIVER_POLL_SLEEP_NS=5000 \
...
PYTHONUNBUFFERED=1 \
  ...
  --fetch-results-dir \
  /tmp/vta_stage_pipeline_results_3_1_1_poll_5us \
  --ssh-option \
