...
exec ./vta_stage_pipeline_runner \
  --stage0-graph stages/vta_conv3x3_c_large_p0/graph.json \
  --stage0-lib stages/vta_conv3x3_c_large_p0/graphlib.so \
  --stage0-params stages/vta_conv3x3_c_large_p0/params.params \
  --stage0-input-names data \
  --stage0-name vta_conv3x3_c_large_p0 \
  --stage0-device vta \
