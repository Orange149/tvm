...
exec ./vta_stage_pipeline_runner \
  --stage0-graph stages/cpu_add_relu_tail_elementwise_p3/graph.json \
  --stage0-lib stages/cpu_add_relu_tail_elementwise_p3/graphlib.so \
  --stage0-params stages/cpu_add_relu_tail_elementwise_p3/params.params \
  --stage0-input-names data \
  --stage0-name cpu_add_relu_tail_elementwise_p3 \
  --stage0-device cpu \
  --stage0-runtime-num-threads 3 \
  --input input.bin \
  --runs 25 \
  --queue-depth 1 \
  --runtime-num-threads 3 \
