...
exec ./vta_stage_pipeline_runner \
  --stage0-graph stages/vta_skip_proj_p1/graph.json \
  --stage0-lib stages/vta_skip_proj_p1/graphlib.so \
  --stage0-params stages/vta_skip_proj_p1/params.params \
  --stage0-input-names data \
  --stage0-name vta_skip_proj_p1 \
  --stage0-device vta \
