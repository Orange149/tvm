...
exec ./vta_stage_pipeline_runner \
  --stage0-graph stages/cpu_head_pool_dense_p1/graph.json \
  --stage0-lib stages/cpu_head_pool_dense_p1/graphlib.so \
  --stage0-params stages/cpu_head_pool_dense_p1/params.params \
  --stage0-input-names data \
  --stage0-name cpu_head_pool_dense_p1 \
  --stage0-device cpu \
