...
exec ./vta_stage_pipeline_runner \
  --stage0-graph stages/cpu_skip_proj_1x1_conv_p1/graph.json \
  --stage0-lib stages/cpu_skip_proj_1x1_conv_p1/graphlib.so \
  --stage0-params stages/cpu_skip_proj_1x1_conv_p1/params.params \
  --stage0-input-names data \
  --stage0-name cpu_skip_proj_1x1_conv_p1 \
  --stage0-device cpu \
