...
exec ./vta_stage_pipeline_runner \
  --stage0-graph stages/bridge_vta_to_cpu_262144/graph.json \
  --stage0-lib stages/bridge_vta_to_cpu_262144/graphlib.so \
  --stage0-params stages/bridge_vta_to_cpu_262144/params.params \
  --stage0-input-names data \
  --stage0-name bridge_vta_to_cpu_262144 \
  --stage0-device cpu \
