...
exec ./vta_stage_pipeline_runner \
  --stage0-graph stages/bridge_vta_to_cpu_4096/graph.json \
  --stage0-lib stages/bridge_vta_to_cpu_4096/graphlib.so \
  --stage0-params stages/bridge_vta_to_cpu_4096/params.params \
  --stage0-input-names data \
  --stage0-name bridge_vta_to_cpu_4096 \
  --stage0-device cpu \
