...
exec ./vta_stage_pipeline_runner \
  --stage0-graph stages/bridge_cpu_to_vta_16384/graph.json \
  --stage0-lib stages/bridge_cpu_to_vta_16384/graphlib.so \
  --stage0-params stages/bridge_cpu_to_vta_16384/params.params \
  --stage0-input-names data \
  --stage0-name bridge_cpu_to_vta_16384 \
  --stage0-device cpu \
