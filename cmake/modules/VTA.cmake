...
elseif(PYTHON)
  ...
  if(USE_VTA_TSIM)
    ...
    list(APPEND TSIM_RUNTIME_SRCS ${VERILATOR_INC_DIR}/verilated_threads.cpp)
    # Target lib: vta_tsim
  ...
  if(USE_VTA_FPGA)
    ...
    elseif("${VTA_TARGET}" STREQUAL "axu5evb")
      list(APPEND FPGA_RUNTIME_SRCS ${VTA_HW_PATH}/src/axu5evb/axu5evb_driver.cc)
